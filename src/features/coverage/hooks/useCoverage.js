...
export const useAmcCycleEconomics = (id) => useQuery({ queryKey: coverageKeys.amcEconomics(id), queryFn: () => api.getAmcCycleEconomics(id), enabled: Boolean(id) })
