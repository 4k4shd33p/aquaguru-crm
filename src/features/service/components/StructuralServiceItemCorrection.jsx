...
import { decideStructuralAllocation } from '../utils/structuralAllocationDecision'
...
function partName(item) { return item?.parts?.name || 'No part' }
...
export function StructuralServiceItemCorrection({ service, item, parts, coverage, allocations, onBack, onSaved }) {
  ...
  const allocationDecision = useMemo(() => decideStructuralAllocation({
    beforeItems: service.service_items,
    afterItems: allocationItems,
    allocations: sharedCostAllocations,
    totals: { technician: service.technician_charge, travel: service.travel_cost, other: service.other_direct_cost },
  }), [allocationItems, service.service_items, service.technician_charge, service.travel_cost, service.other_direct_cost, sharedCostAllocations])
  const showAllocations = allocationDecision.mode === 'manual'
