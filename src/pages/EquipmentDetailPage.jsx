...
export function EquipmentDetailPage() {
  ...
  async function saveEquipment(values) { setFormError(''); try { await updateEquipment.mutateAsync({ equipmentId, values, previousCustomerId: equipment.customer_id, currentCustomerId: equipment.customer_id, currentLocationId: equipment.location_id }); setIsEditOpen(false) } catch (error) { setFormError(equipmentSaveMessage(error)) } }
