...
export const installationKeys = {
  ...
  history: (equipmentId) => ['installations', 'equipment-history', equipmentId], equipmentSearch: (term) => ['installations', 'equipment-search', term], technicians: ['installations', 'technicians'],
}
